...
const Login = () => {
  ...
  return (
    <div>
      ...
      <form onSubmit={(e) =>{e.preventDefault()}} className="w-3/12  my-36 mx-auto left-0 right-0 absolute bg-black p-12 text-white rounded-lg bg-opacity-80">
        ...
        <input
          ...
          className="p-3 my-4 w-full bg-gray-700 "
        />
        <button className="p-3 my-4 w-full bg-red-700 rounded-lg" onClick={handleSignButton}>
